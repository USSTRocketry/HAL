...
SensorAccelGyro::SensorAccelGyro(uint8_t i2c_addr, uint8_t i2c_wire) : Sensor(i2c_addr, i2c_wire) {}

SensorAccelGyro::SensorAccelGyro(uint8_t cs, uint8_t miso, uint8_t mosi, uint8_t sck) : Sensor(cs, miso, mosi, sck) {}
